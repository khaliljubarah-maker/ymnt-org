    ...
    <section id="donate" className="py-24 md:py-32 bg-gradient-brand text-primary-foreground relative overflow-hidden">
      ...
      <div className="container-wide relative text-center max-w-3xl">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <Button size="lg" className="bg-secondary hover:bg-secondary/90 h-12 px-8 text-base shadow-elegant">
            <Heart className="h-5 w-5 me-2" /> {t('home.donate.cta')}
          </Button>
          <Button size="lg" variant="outline" className="bg-transparent border-white/40 text-white hover:bg-white hover:text-primary h-12 px-8 text-base">
