    ...
    <>
      ...
      <section className="py-16">
        <div className="container-wide">
          ...
          <div className="mt-12">
            <DocList
              title={i18n.language === 'ar' ? 'المستندات والمجلدات الشاملة' : 'Comprehensive Documents & Folders'}
              icon={FolderOpen}
              docs={[
                { key: 'annual-reports', ar: 'التقارير الفنية السنوية وتقارير المشاريع', en: 'Annual technical reports & project reports', url: 'https://drive.google.com/drive/folders/1vz6X2hBb1x-A9ichkqlWgYP2BbZwV3by' },
                { key: 'procurement-cycle', ar: 'الدورة المستندية ونماذج لعمليات الشراء والتعاقد', en: 'Document cycle & procurement / contracting templates', url: 'https://drive.google.com/drive/folders/1WpVvsQc8-hxhVeE6zIma0MFCwNR8fxUz' },
                { key: 'bank-accounts', ar: 'الحسابات البنكية للمؤسسة', en: 'Foundation bank accounts', url: 'https://drive.google.com/drive/folders/1DNe0c9pwPToTMnLaiPYFUHBI-lzPp57K' },
                { key: 'official-agreements', ar: 'الاتفاقيات الرسمية للمؤسسة', en: 'Official agreements of the Foundation', url: 'https://drive.google.com/drive/folders/1jaFnoOCLJ7jnb1lExM8qIyck1dkuWyJo' },
              ]}
            />
          </div>
        </div>
